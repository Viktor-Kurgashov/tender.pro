...
let gal = new SwiperMarkers(
  document.getElementsByClassName('reviews__gallery')[0],
  document.getElementsByClassName('reviews__button')[0],
  document.getElementsByClassName('reviews__button')[1],
  document.getElementsByClassName('markers__item'),
